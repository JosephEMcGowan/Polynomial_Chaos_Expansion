...
%figure(3)
%surf(X1,X2,gpcRealIshi)
%xlabel('x1')
%ylabel('x2')
%zlabel('RealIshiGraph')
%colorbar
...
%firstOrder = [SU1, SU2, SU3, 0, 0, 0, 0];
%secondOrder = [0, 0, 0, SU12, SU13, SU23, SU123];
%totalEffect = [SU1T, SU2T, SU3T, 0, 0, 0, 0];
