...
yVec = (rootMAT(:,1)).^5 + (rootMAT(:,2)).^3 + (rootMAT(:,3)).^2;
...
%puts data in order and makes a 3D domain
...
%Graphs the 3D image of the error between our preciction and the real
figure(2)
